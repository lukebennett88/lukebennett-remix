        ...
        {posts.map((post) => (
          <li key={post._id}>
            <Link
              ...
              className="block px-4 py-6 transition duration-300 ease-in-out rounded-lg sm:px-6 lg:px-8 sm:py-8 lg:py-10 dark:hover:bg-gray-700 hover:shadow-lg transform-gpu hover:-translate-y-1 hover:scale-[101%]"
            >
